...
async function go() {
  let client = new MongoClient('mongodb+srv://jessbuckley:Sausages99@cluster0.4yqxgh7.mongodb.net/TodoApp?retryWrites=true&w=majority')
...
function passwordProtected(req, res, next) {
  ...
  if (req.headers.authorization == "Basic dG9kb3VzZXI6U2F1c2FnZXM5OQ==") {
    next()
  } else {
...
app.get("/", async function (req, res) {
  ...
  <title>JBS Simple To-Do App</title>
  ...
  <h1>Va I am going to use this as my primary learning applicaion as i can do more and more funky features!!
